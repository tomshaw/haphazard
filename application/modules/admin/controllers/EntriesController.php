...
class Admin_EntriesController extends Zend_Controller_Action
{
	...
	/**
	 * First level of the listings are categories anything 
	 * deeper than that is considered a normal blog entry.
	 */
	...
	/**
	 * Creates a blog entry row in the database.
	 */
    ...
    /**
     * Edits a blog entry row in the database.
     */
    ...
    /**
     * Deletes a single entry row from the database.
     */
