...
class Admin_UsersController extends Zend_Rest_Controller 
{
    ...
    /**
     * Returns a single user using the get action.
     */
    public function getAction()
    {
    	...
    	if(!$id) {
    		$this->getResponse()->setHttpResponseCode(404)->appendBody(Zend_Json::encode(array('errors'=>'No id provided.')));
    		return;
    	}
    	...
    	if(!$row) {
    		$this->getResponse()->setHttpResponseCode(404)->appendBody(Zend_Json::encode(array('errors'=>'Could not locate specified user using id: ' . $id)));
    		return;
    	}
    ...
    /**
     * Update a current user using the put action.
     */
    public function putAction()
    {
    	...
    	if(!$id) {
    		$this->getResponse()->setHttpResponseCode(503)->appendBody(Zend_Json::encode(array('errors'=>'No id provided.')));
    		return;
    	}
    	...
    	if (null === ($row = $model->fetchRow('id = ' . intval($id)))) {
    		$this->getResponse()->setHttpResponseCode(503)->appendBody(Zend_Json::encode(array('errors'=>'Could not lookup user.')));
    		return;
    	}
    	...
    	if ($request->isPut()) {
    		...
    		if (sizeof($errors)) {
    			$this->getResponse()->setHttpResponseCode(503)->appendBody(Zend_Json::encode(array('errors'=>$errors)));
    			return;
    		}
    		...
    		$this->getResponse()->setBody(Zend_Json::encode(array('success'=>array($message))));
    ...
    /**
     * Create a new system user using the post action.
     */
    public function postAction()
    {
    	...
    	if ($request->isPost()) {
    		...
    		try {
    			...
    			$this->getResponse()->setHttpResponseCode(503)->appendBody(Zend_Json::encode(array('errors'=>$e->getMessage())));
    			return;
    		}
    		
    		$this->getResponse()->setHttpResponseCode(200)->setBody(
    			Zend_Json::encode(array('success'=>array($data['name'] . ' account has been created successfully.')))
    		);
    	...
    	$this->getResponse()->setHttpResponseCode(200)->appendBody(
    		Zend_Json::encode(array('token'=>$token->sessionToken()->getHash()))
    	);
    }
    ...
    public function deleteAction()
    {
    	...
    	$this->getResponse()->setHttpResponseCode(200);
    	$this->getResponse()->setBody(Zend_Json::encode(array('success'=>array('Customer has been deleted successfully.'))));
    }
    ...
    public function secretAction()
    {
    	...
    	$this->getResponse()->setHttpResponseCode(200);
    	$this->getResponse()->setBody(Zend_Json::encode(array('success'=>array('API key was successfully authenticated.'))));    	
    }
