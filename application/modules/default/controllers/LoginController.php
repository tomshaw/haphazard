...
class LoginController extends Zend_Rest_Controller
{
    ...
    public function loginAction()
    {
        ...
        if ($request->isPost()) {
	        ...
	        if (!$result->isValid()) {
	        	$this->getResponse()->setHttpResponseCode(503)->appendBody(Zend_Json::encode(array('errors'=>array('Your account credentials could not be validated.'))));
	        	return;
	        }
	        ...
	        $this->getResponse()->setHttpResponseCode(200)->appendBody(Zend_Json::encode(array('success'=>true)));
    	}
    }
